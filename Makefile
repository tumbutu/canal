#############################################################################
# Makefile for building: canal
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  canal.pro
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile canal.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = canal1.0.0
DISTDIR = /media/sf_shared/POLSIS/STB_dev/canal/.tmp/canal1.0.0
SUBTARGETS    =  \
		sub-src
...
sub-src-qmake_all:  FORCE
	...
	cd src/ && $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro
	cd src/ && $(MAKE) -f Makefile qmake_all
sub-src: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile
...
sub-src-all-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile all
sub-src-all: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile all
sub-src-clean-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile clean
sub-src-clean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile clean
sub-src-distclean-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile distclean
sub-src-distclean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile install
sub-src-install_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile install
sub-src-uninstall_subtargets-ordered: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile uninstall
sub-src-uninstall_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile uninstall

Makefile: canal.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
...
sub-src-debug_ordered:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile debug
debug: sub-src-debug_ordered

sub-src-release_ordered:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile release
release: sub-src-release_ordered

sub-src-check_ordered:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile check
check: sub-src-check_ordered

sub-src-benchmark_ordered:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /media/sf_shared/POLSIS/STB_dev/canal/src/src.pro ) && $(MAKE) -f Makefile benchmark
