...
void AggregatedTraceViewModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AggregatedTraceViewModel *_t = static_cast<AggregatedTraceViewModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AggregatedTraceViewModel::staticMetaObject = {
    { &BaseTraceViewModel::staticMetaObject, qt_meta_stringdata_AggregatedTraceViewModel.data,
      qt_meta_data_AggregatedTraceViewModel,  qt_static_metacall, nullptr, nullptr}
};
