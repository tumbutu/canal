...
void CanListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CanListener *_t = static_cast<CanListener *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CanListener::*_t)(const CanMessage & );
...
const QMetaObject CanListener::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CanListener.data,
      qt_meta_data_CanListener,  qt_static_metacall, nullptr, nullptr}
};
